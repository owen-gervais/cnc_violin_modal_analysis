...
Encoder::Encoder(uint rotary_encoder_A)
{
...
void Encoder::set_rotation(int _rotation)
{
    rotation = _rotation;
}

// get the current rotation
int Encoder::get_rotation(void)
{
    return rotation;
}

int Encoder::get_angle(void)
{
    return rotation*6;
}

void Encoder::pio_irq_handler()
{
